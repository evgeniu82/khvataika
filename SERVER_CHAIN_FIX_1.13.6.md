# Khvataika 1.14.1 — server chain fix

This package keeps the existing 1.14.1 game and gray-screen fix intact and strengthens the online chain:
...
- Server JSON responses expose `X-Khvataika-Version: 1.14.1`.
